...
title1 'Study of Monthly Expense Data-Residual Plot';
symbol1 value=dot
       height=1
       cv=red
       ci=blue
...
proc gplot data=for_graphs;
   plot r_s*AvgExp
              /haxis=axis1
               vaxis=axis2;
         symbol1 value=dot     c=black  height=2;
         axis1 label=('Average Expense');
         axis2 label=(angle=90 'Standard Residuals');
run;
proc gplot data=for_graphs;
   plot r_s*Age
              /haxis=axis1
